      ...
      global: {
        src: {
          ...
          optional: {
            ...
            //     ],
            // },
            // lozad: { // Lazy loader for images, iframes
            //     scripts: [
            //         "{$config.path.node_modules}/lozad/dist/lozad.min.js"
            //     ],
            // },
            // select2: { // Replacement for the standard <select> box
            ...
            bootstrapmaxlength: {
              // visual feedback to the user about the maximum length of the field where the user is inserting text.
            ...
            // },
            inputmask: {
              // Helps the user with the input by ensuring a predefined format.
              scripts: [
            ...
            // },
            autosize: {
              // Adjust textarea height to fit text
            ...
            // bootstrapmultiselectsplitter: { // Transforms a <select> containing one or more <optgroup> in two chained <select>
            ...
            // },
            toastr: {
              // Non-blocking notifications. jQuery required
